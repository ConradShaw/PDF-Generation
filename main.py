...
DESCRIPTIONS = {
    ...
    "Courage": "The capacity to proactively initiate and act on self-directed, purposeful decisions, regardless of uncertainty, risk, or fear.",
...
def generate_individual_pdf_file(
    ...
    legal_notices = Paragraph(
        """
        <i>Shaw Strengths Matrix®</i> is a registered trademark of ShawSight Pty Ltd.<br/>
    ...
    story.append(InfoPanel(
        ...
        • Express these across our <b>Temporal Preferences</b> — <i>Past Reflection</i>, <i>Present Engagement</i>, and <i>Future Anticipation</i><br/>
        ...
        Each Strength is therefore a <b>composite</b> of both <b>Cognitive Preference</b> (<i>Intuition</i>, <i>Thinking</i>, <i>Feeling</i>, and <i>Sensing</i>) and <b>Temporal Preference</b> (<i>Past Reflection</i>, <i>Present Engagement</i>, and <i>Future Anticipation</i>).<br/><br/>
        ...
        These rankings reflect patterns described in the <b>CAPS model</b> (Mischel &amp; Shoda), which explains how an individual’s behaviour varies by situation but forms stable “if–then” personality patterns over time. Your higher-ranked Strengths are those <b>more readily accessible</b> to you and therefore guide your responses in real-world situations more often.<br/>
        """,
...
def generate_team_pdf(
    ...
    legal_notices = Paragraph(
        ...
        <i>Shaw Strengths Matrix® Assessment</i> Copyright 2025 by ShawSight Pty Ltd. All rights reserved.<br/>
        <i>ShawSight</i> logo is Copyright 2025 by ShawSight Pty Ltd. All rights reserved.<br/>
        No part of this publication may be reproduced or shared publicly, including on websites, forums, or social media, without prior written permission from ShawSight Pty Ltd.<br/>
        O*NET is a trademark of the U.S. Department of Labor, Employment and Training Administration.<br/>
        The Shaw Strengths Matrix® is a developmental, strengths-based framework and is not intended for psychological diagnosis, clinical use, or performance benchmarking.""",
    ...
    story.append(InfoPanel(
        ...
        • Apply our <b>Cognitive Preferences</b> — <i>Intuition</i>, <i>Thinking</i>, <i>Feeling</i>, and <i>Sensing</i> —<br/>
        • Express these across our <b>Temporal Preferences</b> — <i>Past Reflection</i>, <i>Present Engagement</i>, and <i>Future Anticipation</i>, and<br/>
        • Intersects these into 12 <b>character strengths</b>, uniquely ranked per individual into 479 million possible combinations.<br/><br/>
        Each Strength is therefore a <b>composite</b> of both <b>Cognitive Preference</b> (<i>Intuition</i>, <i>Thinking</i>, <i>Feeling</i>, and <i>Sensing</i>) and <b>Temporal Preference</b> (<i>Past Reflection</i>, <i>Present Engagement</i>, and <i>Future Anticipation</i>).<br/><br/>
        SSM defines <b>character strengths</b> as "Stable, positive traits expressed in our behaviour that contribute to wellbeing and flourishing. While their expression varies across situations, our overall strength profile remains relatively stable over time."<br/><br/>
    ...
    story.append(InfoPanel(
        ...
        <b>How to Read This Chart</b><br/>
        <br/>
        This chart relabels the team’s 12 ranked <b>SSM Strengths</b> (from the previous charts) into <b>12 Strength Responses to change</b>. It ranks which Strength Responses to change are most likely to cluster within a team and become overexpressed under pressure, translating into <b>Resistant Behaviour risks</b>.<br/>
        <br/>
        ...
        <br/>
        Note that Reframing Strength narratives are designed only to counter overexpressed behaviours. Applying these narratives does not disqualify the original instinctive Strength Response to change.<br/>
        <br/>
        """,
        style=body_compact_style
    ))
